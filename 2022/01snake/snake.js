import * as THREE from "https://cdn.skypack.dev/three@0.136.0/build/three.module";
...
// const geo = new THREE.TorusBufferGeometry(1, 0.4, 32, 100);
const geo = new THREE.TorusBufferGeometry(1.2, 0.32, 200, 340);
...
torus1.rotation.x = THREE.Math.degToRad(115);
torus1.rotation.y = THREE.Math.degToRad(-30);
torus1.position.set(-0.1, 0, 0);
scene.add(torus1);

const torus2 = torus1.clone();
torus2.rotation.x = THREE.Math.degToRad(85);
torus2.rotation.y = THREE.Math.degToRad(18);
torus2.position.set(1, 0.05, -0.2);
scene.add(torus2);

const torus3 = torus1.clone();
torus3.rotation.x = THREE.Math.degToRad(160);
torus3.rotation.y = THREE.Math.degToRad(-45);
torus3.position.set(-0.6, 0.1, 0.5);
scene.add(torus3);

const torus4 = new THREE.Mesh(new THREE.TorusBufferGeometry(1.2, 0.45, 200, 350), mat);
torus4.rotation.x = THREE.Math.degToRad(40);
torus4.rotation.y = THREE.Math.degToRad(60 + 180);
torus4.position.set(0.3, 0.6, -0.9);
scene.add(torus4);

const torus5 = torus1.clone();
torus5.rotation.x = THREE.Math.degToRad(-70);
torus5.rotation.y = THREE.Math.degToRad(-115);
torus5.position.set(1.7, 0.0, 0.4);
scene.add(torus5);

const torus6 = torus1.clone();
torus6.rotation.x = THREE.Math.degToRad(45);
torus6.rotation.y = THREE.Math.degToRad(-115);
torus6.position.set(1.8, -0.3, -0.2);
scene.add(torus6);

const torus7 = torus1.clone();
torus7.rotation.x = THREE.Math.degToRad(85);
torus7.rotation.y = THREE.Math.degToRad(40 + 180);
